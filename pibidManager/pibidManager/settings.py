"""
Django settings for pibidManager project.
...
ROOT_URLCONF = 'pibidManager.urls'

LOGIN_URL = 'pontoEletronico:index'
LOGIN_REDIRECT_URL = 'pontoEletronico:index'
LOGOUT_URL = 'pontoEletronico:index'
...
WSGI_APPLICATION = 'pibidManager.wsgi.application'
